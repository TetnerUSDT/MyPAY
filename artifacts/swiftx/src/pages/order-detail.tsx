...
import { ArrowLeft, Clock, AlertTriangle, CheckCircle2, Shield, Copy, XCircle, Send, MessageSquare } from "lucide-react";
...
export default function OrderDetail({ backPath = "/" }: { backPath?: string }) {
          ...
          <div className="flex items-center justify-between">
            <div>
              <button
                ...
                className="mb-4 inline-flex items-center gap-2 text-xs font-semibold text-white/45 transition hover:text-white"
              >
