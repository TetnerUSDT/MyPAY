...
import { db } from "./db";
import { balances, exchanges, cards, banks, exchangeRates, supportTickets, supportMessages, supportChats, users, wallets, admins, userCards, usersBalances, botCommands, botCommandReactions, botCommandFiles, botMenus, botMenuButtons } from "@workspace/db/schema";
import { eq, desc, sql, and, not } from "drizzle-orm";
import { insertBalanceSchema, insertCardSchema, insertBankSchema, insertExchangeRateSchema, insertSupportMessageSchema, insertAdminSchema, insertUsersBalancesSchema, insertBotCommandSchema, insertBotCommandReactionSchema, insertBotCommandFileSchema, insertBotMenuSchema, insertBotMenuButtonSchema } from "@workspace/db/schema";
